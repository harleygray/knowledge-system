...
You'll have the `knowledge-system.webhapp` in `workdir`. This is what you should distribute so that the Holochain Launcher can install it.

You will also have its subcomponent `knowledge-system.happ` in the same folder`.
